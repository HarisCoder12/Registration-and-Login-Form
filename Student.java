...
public class Student implements Serializable {
    ...
    public Student(long id, String name, Date dob, String gender, String mailId, String mobileNo, String password, String rePassword, String program, String branch, int semester, Timestamp addDate) {
        this.id = id;
        this.name = name;
        this.dob = dob;
        this.gender = gender;
